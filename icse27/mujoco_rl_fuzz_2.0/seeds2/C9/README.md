# C9 — MJX / backend differential / plugin / action dim

> Same model differs across classic / MJX / Brax / madrona-mjx / wrappers in dim / contact / sensor / state / plugin.

**Doc anchor:** `C9. MJX / backend differential / plugin / action dimension 类`
...
- `classic_vs_mjx_diff`
- `plugin_toggle`
- `actdim_action_mutation`
- `batched_vmap_action`
- `eq_active_toggle`
- `contact_pair_generation`
- `sensor_readback`
- `mjx_state_get_put`
- `renderer_randomization_mutation`

## Suggested oracles

- `action_space_consistency`
- `state_trajectory_residual`
- `contact_count_force_diff`
- `sensor_backend_residual`
- `shape_mismatch`
- `plugin_recognition`
- `same_seed_backend_divergence`
...
- `mujoco__model_plugin_actuator_pid`

# C10 — JAX/MJX 可微 / GPU 数值 / 精度

> GPU batched / differentiable training: gradient, jacobian, XLA / cusolver, precision NaN / hard-error.

**Doc anchor:** `C10. JAX/MJX differentiability / GPU numerical / precision 类`
...
- `jax_grad_jac`
- `contact_boundary_sweep`
- `solver_switch`
- `x64_toggle`
- `batch_size_sweep`
- `cuda_jax_version_matrix`
- `ppo_smoke`
- `seed_sweep`
